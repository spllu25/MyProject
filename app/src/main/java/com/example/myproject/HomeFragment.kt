    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (userCards.isEmpty()) {
                ...
                staticCards.add(Card(2,"image1", getString(R.string.title2), getString(R.string.txt2), false, false, false, 0, ""))
                staticCards.add(Card(3,"image1", getString(R.string.title3), getString(R.string.txt3), false, false, false, 0, ""))
                staticCards.add(Card(4,"image1", getString(R.string.title4), getString(R.string.txt4), false, false, false, 0, ""))
